    ...
    <div className="modal-overlay">
      ...
      >
        ...
        <div className="modal-top-navbar" style={{ flexShrink: 0, zIndex: 10 }}>
          ...
          <div style={{ background: 'linear-gradient(135deg, #1e1b4b 0%, #701a75 100%)', padding: '0.95rem 1.15rem', paddingTop: 'max(0.95rem, env(safe-area-inset-top))', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
