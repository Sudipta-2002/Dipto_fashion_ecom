...
//         onClick={(e) => e.stopPropagation()}
//       >
//         {/* HEADER HERO (CANCEL ORDER REQUEST MODAL-ER MOTO HEIGHT ADJUSTED) */}
//         <div
//           style={{
//             background: 'linear-gradient(135deg, #701a75 0%, #c026d3 50%, #e879f9 100%)',
//             padding: '0.85rem 1.25rem',
//             paddingTop: isMobile ? 'calc(54px + env(safe-area-inset-top, 0px))' : '1.25rem',
  ...
  return (
    ...
    >
      <div
        ...
        onClick={(e) => e.stopPropagation()}
      >
        {/* HEADER HERO (GAP ADJUSTED TO REMOVE EXTRA TOP SPACE) */}
        <div
          style={{
            background: 'linear-gradient(135deg, #701a75 0%, #c026d3 50%, #e879f9 100%)',
            padding: '0.85rem 1.25rem',
        ...
        >
          ...
          {/* EXTRA BOTTOM BUFFER SPACE (Clearance for Bottom Navigation Bar) */}
          <div 
            style={{ 
              height: isMobile ? 'calc(120px + env(safe-area-inset-bottom, 20px))' : '1.5rem', 
              width: '100%', 
              flexShrink: 0 
            }} 
          />
