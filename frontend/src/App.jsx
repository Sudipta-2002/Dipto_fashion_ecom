...
//           // Full page redirect fallback (if not opened in popup)
//           if (typeof setUser === 'function') setUser(safeUser);
//           if (typeof setIsAuthOpen === 'function') setIsAuthOpen(false);
//           if (typeof setCurrentView === 'function') setCurrentView('shop');
//           window.history.replaceState({}, '', '/');
//         } catch (err) {
...
function App() {
  ...
  // পপআপ উইন্ডোতে পুরো অ্যাপ রেন্ডার হওয়া বন্ধ করতে আইসোলেটেড ক্লিন লোডার
  if (
      ...
      >
        <div
          style={{
            ...
            borderTop: '3.5px solid #c026d3',
            borderRadius: '50%',
            animation: 'dfSpin 0.75s linear infinite'
          }}
        />
        <p style={{ fontSize: '0.9rem', color: '#475569', fontWeight: '700', margin: 0 }}>
          Connecting to Dipto Fashion...
        </p>
        <style>{`
          @keyframes dfSpin {
