// firebase.js
// Firebase Phone Auth — OTP is sent and verified entirely on the client
// using signInWithPhoneNumber + RecaptchaVerifier (Firebase Auth SDK).
// The backend does NOT send or store OTPs.
